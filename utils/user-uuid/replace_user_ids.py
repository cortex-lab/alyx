...
renames = [
    ...
    ('subjects.sequence', 'informal_name', 'name'), ('subjects.allele', 'standard_name', 'name'),
    ('subjects.species', 'display_name', 'nickname'), ('subjects.line', 'auto_name', 'nickname'),
    ('subjects.allele', 'informal_name', 'nickname'), ('data.datarepository', 'dns', 'hostname'), ]
