...
# -*- coding: utf-8 -*-
#
# Alyx documentation build configuration file, created by
# sphinx-quickstart on Sat May  7 17:41:14 2016.
#
...
import django
sys.path.insert(0, os.path.abspath('../alyx/'))  # so sphinx can find modules, and also to allow django to set up
...
man_pages = [
    (master_doc, 'alyx', 'Alyx Documentation',
     [author], 1)
]
