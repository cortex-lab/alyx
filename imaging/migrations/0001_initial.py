    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('excitation_device', models.CharField(blank=True, help_text='e.g. LED part number. Can be array for multispectral. TODO: Appliance subclass - what name?', max_length=255, null=True)),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, help_text='2P imaging stack. TODO: multiple sortings?', null=True, on_delete=django.db.models.deletion.CASCADE, to='imaging.TwoPhotonImaging'),
        ),
        migrations.AddField(
            model_name='roi',
