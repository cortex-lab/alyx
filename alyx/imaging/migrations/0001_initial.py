...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='roi',
            name='session',
            field=models.ForeignKey(help_text='The Session to which this data belongs', on_delete=django.db.models.deletion.CASCADE, related_name='imaging_roi_related', to='actions.Session'),
        ),
    ]
