    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('session', models.ForeignKey(help_text='The Session to which this data belongs', on_delete=django.db.models.deletion.CASCADE, related_name='imaging_roi_related', to='actions.Session')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('session', models.ForeignKey(help_text='The Session to which this data belongs', on_delete=django.db.models.deletion.CASCADE, related_name='imaging_roidetection_related', to='actions.Session')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('session', models.ForeignKey(help_text='The Session to which this data belongs', on_delete=django.db.models.deletion.CASCADE, related_name='imaging_svdcompressedmovie_related', to='actions.Session')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imaging_indicator', models.CharField(blank=True, help_text='<GCaMP6f, GCaMP6m, GCaMP6s …>. TODO: normalize!', max_length=255)),
                ...
                ('session', models.ForeignKey(help_text='The Session to which this data belongs', on_delete=django.db.models.deletion.CASCADE, related_name='imaging_twophotonimaging_related', to='actions.Session')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('session', models.ForeignKey(help_text='The Session to which this data belongs', on_delete=django.db.models.deletion.CASCADE, related_name='imaging_widefieldimaging_related', to='actions.Session')),
