    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notes', models.TextField(blank=True)),
                ('line', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='subjects.Line')),
                ('user', models.ForeignKey(blank=True, help_text='Who requested this subject.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='subjects_requested', to='misc.OrderedUser')),
            ],
            options={
                'ordering': ['-date_time'],
            },
