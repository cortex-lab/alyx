    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('housing', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='housing_subjects', to='misc.Housing')),
                ('subject', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='housing_subjects', to='subjects.Subject')),
