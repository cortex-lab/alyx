    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('experiment', models.ForeignKey(help_text='The Experiment to which this data belongs', on_delete=django.db.models.deletion.CASCADE, related_name='behavior_eventseries_related', to='actions.Experiment')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('experiment', models.ForeignKey(help_text='The Experiment to which this data belongs', on_delete=django.db.models.deletion.CASCADE, related_name='behavior_headtracking_related', to='actions.Experiment')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('generating_software', models.CharField(blank=True, help_text="e.g. 'ChoiceWorld 0.8.3'", max_length=255)),
                ('experiment', models.ForeignKey(help_text='The Experiment to which this data belongs', on_delete=django.db.models.deletion.CASCADE, related_name='behavior_intervalseries_related', to='actions.Experiment')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('experiment', models.ForeignKey(help_text='The Experiment to which this data belongs', on_delete=django.db.models.deletion.CASCADE, related_name='behavior_optogeneticstimulus_related', to='actions.Experiment')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('experiment', models.ForeignKey(help_text='The Experiment to which this data belongs', on_delete=django.db.models.deletion.CASCADE, related_name='behavior_pharmacology_related', to='actions.Experiment')),
            ],
            options={
